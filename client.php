...
<script type="text/javascript">
    ...
    var flashvars = {
            ...
            "external.override.texts.txt" : "<?php echo $client['texts']; ?>", 
            "external.override.variables.txt" : "<?php echo $client['vars']; ?>", 
...
<?php } ?>
    ...
    FlashExternalInterface.signoutUrl = "http://testqubise.no-ip.org/account/logout";
