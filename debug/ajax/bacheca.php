    ...
    ?>
             ...
             <div class="twtr-tweet-wrap">
                      <div class="twtr-avatar"> 
                         ...
                         <?php if($while['user_name'] == $sistema->utente('username', 'username', $_SESSION['username']) OR $sistema->utente('username', 'username', $_SESSION['username']) == $while['nomeprofilo'] OR $sistema->permessi('bacheca','rank',$sistema->utente('rank','username',$_SESSION['username'])) == 1){ 
