...
<body>
	...
	<header id="header">
		<hgroup>
			...
			<h2 class="section_title">Sbanna un utente</h2><div class="btn_view_site"><a href="../home.php?usr=<?php echo $_SESSION['username']; ?>">Vai alla home</a></div>
		</hgroup>
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="index.php">Housekeeping</a> <div class="breadcrumb_divider"></div> <a class="current">Sbanna un utente</a></article>
		</div>
